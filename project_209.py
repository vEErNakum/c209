...
try:
    ...
    def _on_collision(data):
        ...
        Collision_event_recorded = data.normal_impluse
        intensity_of_collision = math.sqrt(Collision_event_record.x ** 2 + Collision_event_record.y ** 2 + Collision_event_recorded.z ** 2)
